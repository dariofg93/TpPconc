...
public class ComplexUser extends ConcurUser {
	...
	public ComplexUser(MonitorConcurDerivative monitor, MonitorConcurDerivative otroMonitor, Integer funcion, Integer...setORget) {
	...
	public void run() {
		...
		case 1 : System.out.println("NO CORRESPONDE LA OPERACION A UN USUARIO SIMPLE");
				 break;
		case 2 : concurDerivative.set(setORgetCase[0],setORgetCase[1]);
				 break;
		}
	}
